...
import ren.ashin.db.migration.assistant.bean.DataValue;
import ren.ashin.db.migration.assistant.bean.TmpExpData;
import ren.ashin.db.migration.assistant.errorenum.ParamError;
import ren.ashin.db.migration.assistant.render.ButtonRendererListener;
import ren.ashin.db.migration.assistant.render.ButtonRendererListenerImp;
import ren.ashin.db.migration.assistant.render.CellRenderer;
import ren.ashin.db.migration.assistant.render.CellRendererImp;
import ren.ashin.db.migration.assistant.render.CellToolTip;
import ren.ashin.db.migration.assistant.render.DialogUtil;
import ren.ashin.db.migration.assistant.render.DisplayJFrame;
import ren.ashin.db.migration.assistant.util.BeanUtil;
import ren.ashin.db.migration.assistant.util.Conf;
import ren.ashin.db.migration.assistant.util.Conf4Exp;
import ren.ashin.db.migration.assistant.util.Conf4Imp;
import ren.ashin.db.migration.assistant.util.DatabaseUtil;
import ren.ashin.db.migration.assistant.util.TransferSizeUtil;
import ren.ashin.db.migration.assistant.util.ValidateUtil;
import ren.ashin.db.migration.assistant.widget.BytesChooser;
import ren.ashin.db.migration.assistant.widget.DateChooser;
...
public class MigrationAssistant extends JFrame {
    Logger LOGGER = Logger.getLogger(MigrationAssistant.class);
    ...
    class JmiAddFileListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (jfc.showOpenDialog(MigrationAssistant.this) == JFileChooser.APPROVE_OPTION) {
    ...
    class JmiAddDirListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (chooser.showOpenDialog(MigrationAssistant.this) == JFileChooser.APPROVE_OPTION) {
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
        ...
        DisplayJFrame.runJFrame(new MigrationAssistant(), expToolName, 800, 600);
